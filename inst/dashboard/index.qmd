...
calendar_events <- tryCatch({
  ...
  if (service_account_json == "" || is.na(service_account_json)) {
    ...
    tomorrow_end <- paste0(Sys.Date() + 1, "T23:59:59Z")
    ...
    debug_info <- paste(
      ...
      "| Time range:", today_start, "to", tomorrow_end,
      "| Today:", Sys.Date(), "| Tomorrow:", Sys.Date() + 1
    )
...
calendar_events |>
  tinytable::tt(caption = "Today & Tomorrow's Schedule")
```
